...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { city: @temperature.city, month: @temperature.month, temperature: @temperature.temperature }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { city: @temperature.city, month: @temperature.month, temperature: @temperature.temperature }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
